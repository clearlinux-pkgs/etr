...
Source0  : https://sourceforge.net/projects/extremetuxracer/files/releases/0.8.3/etr-0.8.3.tar.xz
...
%prep
%setup -q -n etr-0.8.3
cd %{_builddir}/etr-0.8.3
pushd ..
cp -a etr-0.8.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701954031
