...
Version  : 0.8.4
Release  : 8
URL      : https://sourceforge.net/projects/extremetuxracer/files/releases/0.8.4/etr-0.8.4.zip
Source0  : https://sourceforge.net/projects/extremetuxracer/files/releases/0.8.4/etr-0.8.4.zip
...
%description
See https://sourceforge.net/projects/extremetuxracer/
...
%prep
%setup -q -n etr-0.8.4
cd %{_builddir}/etr-0.8.4
pushd ..
cp -a etr-0.8.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715298273
...
cp %{_builddir}/etr-%{version}/COPYING %{buildroot}/usr/share/package-licenses/etr/4cc77b90af91e615a64ae04893fdffa7939db84c || :
export GOAMD64=v2
GOAMD64=v3
pushd ../buildavx2/
%make_install_v3
...
/usr/share/etr/translations/du_NL.lst
/usr/share/etr/translations/eo.lst
...
/usr/share/metainfo/net.sourceforge.extremetuxracer.metainfo.xml
...
%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/etr/4cc77b90af91e615a64ae04893fdffa7939db84c
