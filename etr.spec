...
Version  : 0.8.0
Release  : 2
URL      : https://sourceforge.net/projects/extremetuxracer/files/releases/0.8.0/etr-0.8.0.tar.xz
Source0  : https://sourceforge.net/projects/extremetuxracer/files/releases/0.8.0/etr-0.8.0.tar.xz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1584378480
...
cp %{_builddir}/etr-0.8.0/COPYING %{buildroot}/usr/share/package-licenses/etr/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
