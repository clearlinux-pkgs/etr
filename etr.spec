...
Source0  : https://sourceforge.net/projects/extremetuxracer/files/releases/0.8.2/etr-0.8.2.tar.xz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655388606
...
cp %{_builddir}/etr-0.8.2/COPYING %{buildroot}/usr/share/package-licenses/etr/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
...
/usr/share/metainfo/etr.appdata.xml
